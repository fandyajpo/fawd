...
// const Footer = memo(() => {
//   return (
//     <div className="bg-darkred flex items-center justify-center mt-24">
        ...
        <div className="pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl ">
          <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
            ...
            <div className="md:max-w-md lg:col-span-2">
              <span className="text-base font-medium tracking-wide text-gray-800">
              ...
              <p className="mt-4 text-sm text-gray-500">
                Theres no way to lose!, comes up with us build an arogant
                software
              </p>
            </div>
          </div>
          <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
            <p className="text-sm text-gray-500">
              © Copyright 2020 Next Store. All rights reserved.
            </p>
