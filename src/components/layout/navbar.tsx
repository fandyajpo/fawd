...
const Navbar = () => {
  ...
  return (
    <>
      <div className="bg-white/50 shadow shadow-gray200 sticky top-0 z-50 backdrop-blur-xl w-full h-14 flex flex-row items-center justify-between px-4 md:px-8 lg:px-44">
        <div
